...
export const CAR_MODELS: Record<string, string[]> = {
  ...
  'Fiat': [
    ...
    'Grand Siena', 'Marea', 'Mobi', 'Palio', 'Pulse', 'Scudo', 'Siena',
    'Strada', 'Toro', 'Uno',
  ],
  'Ford': [
    'Bronco', 'Bronco Sport', 'EcoSport', 'Edge', 'F-150', 'F-150 Lightning',
    'Fiesta', 'Focus', 'Fusion', 'Ka', 'Ka Sedan', 'Maverick', 'Mustang',
    'Mustang Mach-E', 'Ranger', 'Territory', 'Transit',
  ],
  'GWM': [
  ...
  'Renault': [
    ...
    'Megane', 'Megane E-Tech', 'Oroch', 'Sandero', 'Sandero RS', 'Stepway',
    'Symbol', 'Zoe',
  ],
  'Subaru': [
  ...
  'Volkswagen': [
    'Amarok', 'Arteon', 'Fox', 'Fusca', 'Gol', 'Golf', 'Golf GTI', 'Golf R',
    'ID.3', 'ID.4', 'ID.Buzz', 'Jetta', 'Jetta GLI', 'Nivus', 'Passat',
