  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className={`
        ...
        ${isDarkMode
          ? 'bg-gray-900/80 border-[3px] border-gray-600/80 shadow-[0_8px_30px_rgba(0,0,0,0.4)]'
          : 'bg-white/80 border-[3px] border-gray-400/80 shadow-[0_8px_30px_rgba(0,0,0,0.25)]'
        }
      `}>
        <button
      ...
      <div className="relative">
        <button
          ...
          className={`
            ...
            ${isDarkMode
              ? 'bg-gray-900/80 border-[3px] border-gray-600/80 hover:border-gray-500 text-gray-300 shadow-[0_8px_30px_rgba(0,0,0,0.4)]'
              : 'bg-white/80 border-[3px] border-gray-400/80 hover:border-gray-500 text-gray-700 shadow-[0_8px_30px_rgba(0,0,0,0.25)]'
            }
          `}
        >
