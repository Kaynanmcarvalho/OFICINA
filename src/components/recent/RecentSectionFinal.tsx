...
const RecentSectionFinal: React.FC<RecentSectionFinalProps> = ({
  items,
  isLoading = false,
  onItemClick,
  onItemAction,
...
export default RecentSectionFinal;