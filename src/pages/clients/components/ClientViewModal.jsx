              ...
              <div className="relative flex items-center justify-between px-6 py-5 border-b border-neutral-200 dark:border-neutral-800">
                <div className="flex items-center gap-4">
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-green-500 rounded-full border-2 border-white dark:border-neutral-900 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-1">
                      ...
                      <span className="text-xs text-neutral-500 dark:text-neutral-400 flex items-center gap-1">
                        ...
                        Cadastrado em {formatDate(client.createdAt)} ({diasCadastrado} dias)
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <button
                  onClick={onClose}
                  className="md:hidden p-2 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all duration-200 text-neutral-500 hover:text-neutral-900 dark:hover:text-neutral-100"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
                    ...
                    <div className="space-y-4">
                      {clientHistory.map((visit, index) => (
                        <motion.div
                          ...
                          className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 overflow-hidden hover:shadow-lg transition-all duration-300"
                        >
                          <div 
            ...
            <div className="flex-shrink-0 px-6 py-4 border-t border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900/50">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={onClose}
                    className="px-6 py-2 rounded-lg font-medium text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all duration-200 border border-neutral-300 dark:border-neutral-600"
                  >
                    Fechar
                  </button>
                </div>
