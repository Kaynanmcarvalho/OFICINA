      ...
      <GlassCard className="p-6">
        ...
        <div className="mb-8">
          <div className="flex items-start justify-between mb-4">
            ...
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-lg shadow-orange-500/30"
            >
              <TrendingUp className="w-5 h-5" />
              <div className="text-right">
                <div className="text-2xl font-bold">{Math.round(progress)}%</div>
                <div className="text-xs opacity-90">{completedStages}/{totalStages} etapas</div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 mt-4">
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-medium text-orange-700 dark:text-orange-300">Em andamento</span>
              </div>
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-medium text-gray-700 dark:text-gray-300">Pendentes</span>
              </div>
                  ...
                  <div className="text-center min-w-[80px]">
                    ...
                    {status === 'completed' && (
                      <motion.span
                        ...
                        className="inline-block mt-1 px-2 py-0.5 rounded-full bg-green-100 dark:bg-green-900/30 text-[10px] font-medium text-green-600 dark:text-green-400"
                      >
                        ✓ Concluído
                      </motion.span>
                    )}
                    {status === 'current' && (
                      <motion.span
                        ...
                        transition={{ duration: 2, repeat: Infinity }}
                        className="inline-block mt-1 px-2 py-0.5 rounded-full bg-orange-100 dark:bg-orange-900/30 text-[10px] font-medium text-orange-600 dark:text-orange-400"
                      >
                        ● Em andamento
                      </motion.span>
                    )}
        ...
        {currentStage && (
          <motion.div
            ...
            className="mt-6"
          >
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 p-6 text-white shadow-xl shadow-orange-500/30">
              {/* Background Pattern */}
              ...
              <div className="relative">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-xs font-medium opacity-90 mb-1">Estágio Atual</div>
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex items-center gap-2 font-semibold">
                        {(() => {
                          ...
                          return NextIcon && <NextIcon className="w-4 h-4" />;
                        })()}
